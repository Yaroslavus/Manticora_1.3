...
import manticora_multiprocessing
#==============================================================================
# All user sets saves in main branch (manticora_main_fast, HERE)===============
# and oly main branch has access to operate them ==============================
#==============================================================================

print("{0}Manticora 1.3 FAST mode{0}\n\n".format("_"*39))
...
manticora_multiprocessing.to_process_mult(START_TIME)
TOTAL_DICT_OF_DAYS = manticora_multiprocessing.count_tails_range_mult(START_TIME)
manticora_multiprocessing.fill_the_summary_files_mult(TOTAL_DICT_OF_DAYS, START_TIME)
